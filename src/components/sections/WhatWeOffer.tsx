...
function OfferRow({
  ...
  return (
    ...
    >
      ...
      <div
        className="pointer-events-none absolute left-[58%] top-1/2 z-20 hidden -translate-x-1/2 -translate-y-1/2 -rotate-[4deg] scale-0 opacity-0 transition-all duration-700 ease-out group-hover:scale-190 group-hover:opacity-100 lg:block"
      >
