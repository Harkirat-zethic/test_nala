...
export default function SDAProperties() {
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "px-6 transition-all duration-[2000ms] ease-out sm:px-8 md:px-12",
          "lg:absolute lg:left-[7.8%] lg:top-[25%] lg:z-10 lg:w-[44.5%] lg:px-0",
          isVisible
            ? "translate-y-0 opacity-100"
            : "translate-y-10 opacity-0 lg:opacity-20"
        )}
      >
      ...
      <p
        ...
        className={cn(
          "mt-6 px-6 text-base leading-[28px] transition-all duration-[2000ms] ease-out sm:px-8 md:px-12",
          "lg:absolute lg:left-[8%] lg:top-[65.4%] lg:z-10 lg:mt-0 lg:w-[19.6%] lg:px-0 lg:text-[clamp(14px,1.04vw,20px)] short:text-[1.9vh] short:text-[1.9vh]",
          isVisible
            ? "translate-y-0 opacity-100"
            : "translate-y-10 opacity-0 lg:opacity-20"
        )}
      ...
      <div
        className={cn(
          "mx-6 overflow-hidden rounded-[4px] transition-all duration-[2000ms] ease-out sm:mx-8 md:mx-auto md:max-w-[500px]",
      ...
      >
        <div className="relative h-[480px] w-full sm:h-[550px] lg:h-full">
          ...
          <Image
            ...
            fill
            className={cn(
              "z-10 transition-all duration-[2000ms] ease-out",
              isVisible
      ...
      <p
        style={{ fontFamily: "'Outfit', sans-serif" }}
        className={cn(
          "mx-6 mt-8 text-base leading-relaxed text-[#5b5b5b] transition-all duration-[2000ms] ease-out sm:mx-8 md:mx-12",
          "lg:absolute lg:left-[60.1%] lg:top-[40.2%] lg:z-10 lg:mx-0 lg:w-[32.1%] lg:text-[clamp(16px,1.46vw,28px)] lg:leading-[1.36em] short:text-[2.6vh] short:text-[2.6vh]",
          isVisible
            ? "translate-y-0 opacity-100"
            : "translate-y-10 opacity-0 lg:opacity-20"
        )}
